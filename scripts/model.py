...
inf_df.to_csv(f'data/re1.5/infections_{multiplier}.csv', header=None, index=False) # save location can be changed for different Re
df = pd.DataFrame(death)
df.to_csv(f'data/re1.5/deaths_{multiplier}.csv', header=None, index=False)
df = pd.DataFrame(hosp)
df.to_csv(f'data/re1.5/hospitalisations_{multiplier}.csv', header=None, index=False)
age_deaths_df = pd.DataFrame(avg_age_deaths)
age_deaths_df.to_csv(f'data/re1.5/age_deaths_{multiplier}.csv', header=None, index=False)
